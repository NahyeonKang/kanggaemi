"""
app/scrapers/kis/kis_domestic_bond_rate_scraper.py
...
class KISDomesticBondRateScraper:
    ...
    def fetch_comp_interest(
        ...
        return DomesticBondRateData(
            source="kis",
            market_div_code=fid_cond_mrkt_div_code,
            screen_div_code=fid_cond_scr_div_code,
...
def _parse_items(raw: object) -> list[DomesticBondRateItem]:
    if not raw:
        return []
    rows = raw if isinstance(raw, list) else [raw]
    return [
        DomesticBondRateItem(
